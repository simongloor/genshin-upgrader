...
export const characterData = {
  ...
  Anastasya: { name: 'Anastasya', element: 'Cryo', weapon: 'Unknown' },
  ...
  Lohen: { name: 'Lohen', element: 'Cryo', weapon: 'Polearm' },
  Odette: { name: 'Odette', element: 'Cryo', weapon: 'Sword' },
  ...
  Vodyanitsa: { name: 'Vodyanitsa', element: 'Hydro', weapon: 'Catalyst' },
  ...
  Mitya: { name: 'Mitya', element: 'Electro', weapon: 'Unknown' },
  ...
  Alyosha: { name: 'Alyosha', element: 'Electro', weapon: 'Polearm' },
  Beidou: { name: 'Beidou', element: 'Electro', weapon: 'Claymore' },
  Danica: { name: 'Danica', element: 'Electro', weapon: 'Unknown' },
  ...
  Valeriy: { name: 'Valeriy', element: 'Electro', weapon: 'Unknown' },
